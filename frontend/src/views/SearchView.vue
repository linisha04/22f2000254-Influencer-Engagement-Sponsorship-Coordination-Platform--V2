...
<template>
    <div v-if="store.getters.getRoles.includes('influencer')">
                    ...
                    <tr v-for="camp in CampORInf" :key="camp.id" class="table-success">
                        ...
                        <td class="table-primary">
                            <button @click="router.push(`/createAdRequest/campaign_id/${camp.id}`)">Create Ad
                                Requests</button>
                            <button @click="router.push(`/viewAdRequests/campaign_id/${camp.id}`)">view Ad
                                Requests</button>
        ...
        <div v-else>
            ...
            <button type="button" @click="router.push({ name: 'influencerDashboard' })">Dashboard</button>
        </div>
            ...
            <table class="table  table-striped-columns  ">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="table-light">bio <button type="button"
